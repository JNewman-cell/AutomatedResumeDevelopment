...
\section{\textbf{Work Experience}}
  \resumeSubHeadingListStart
    ...
    {Software Engineer}{April 2025 - July 2025}
    \resumeItemListStart
        \resumeItem{Built out Java backend and Typescript frontend for auditing feature, reducing time spent auditing by 90\%.}
        \resumeItem{Orchestrated cross-team efforts to deliver the full auditing feature on time and fully functional.}
        \resumeItem{Created new permission using Oracle DB, improving permission enabling workflows by 40\%.}
        \resumeItem{Enhanced AI chatbot accuracy by 30\% by building Retrieval-Augmented Generation (RAG) pipeline.}
        \resumeItem{Enhanced AI chatbot accuracy by 10\% by designing specialized agent workflows.}
    \resumeItemListEnd
    \resumeSubheading
