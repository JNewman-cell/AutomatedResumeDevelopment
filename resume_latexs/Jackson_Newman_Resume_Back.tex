...
\section{Projects}
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
            ...
            {}
            \resumeItemListStart
            \resumeItem{Developed CRUD operations in a Java back-end for PostgreSQL database, deploying six key functions.}
            \resumeItem{Created a comprehensive testing suite to cover 100\% of query functionality, including error handling.}
            \resumeItem{Integrated testing into the CI/CD workflow, ensuring near 100\% up time in production.}
          \resumeItemListEnd
        \resumeProjectHeading
