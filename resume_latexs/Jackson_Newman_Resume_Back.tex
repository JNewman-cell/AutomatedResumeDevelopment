...
\section{\textbf{Work Experience}}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItem{Developed Java REST API for fetching audit logs for products, enabling 30\% faster auditing}
        \resumeItem{Created audit logs React front-end, enabling 80\% faster resolution of permission issues.}
        \resumeItem{Created new permission Oracle DB, improving permission enabling workflows by 40\%.}
        \resumeItem{Improved AI chatbot agentic workflows by 15\% by improving RAG functions.}
    \resumeItemListEnd
    \resumeSubheading
...
\section{\textbf{Projects}}
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
            ...
            \resumeItem{Configured Maven backend unit and mutation testing into CI/CD workflow, ensuring 100\% up time.}
